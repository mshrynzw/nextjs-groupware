...
import { Plus, Minus, Search, Users, Mail, BadgeCheck, ArrowLeft } from 'lucide-react';
...
export default function NewChatPage() {
  ...
  function addGroupUsers(groupId: string) {
  ...
  function removeGroupUsers(groupId: string) {
    const groupUsers = usersWithGroups.filter((u) => u.groups.some((c) => c.id === groupId));
